...
<div class="container">
		...
		<br>
<a href="products.php" class="btn btn-success btn-xs-2x" style="float: none;">Back</a>
...
<table id="resultTable" data-responsive="table">
	...
	<tbody>
			...
			<td><center><a href="#" id="<?php echo $row['product_id']; ?>" class="delbutton" title="Click To Delete">DELETE</a>  </center></tr>
			<?php
				}
			?>

...
<br>
<br>
<a rel="facebox" href="productmng.php" class="btn btn-default" style="float: right;" >manage product</a>
...
<table id="resultTable" data-responsive="table">
	...
	<tbody>
			...
			<td><center><a rel="facebox" href="editproduct.php?id=<?php echo $row['product_id']; ?>" class="btn btn-warning btn-xs-2x"> Edit </a> <a rel="facebox" href="editproduct1.php?id=<?php echo $row['product_id']; ?>" class="btn btn-warning btn-xs-2x"> Load qty </a> <a rel="facebox" href="productdetail.php?id=<?php echo $row['product_id']; ?>" class="btn btn-warning btn-xs-2x"> detail </a> </center></tr>
			<?php
				}
			?>
